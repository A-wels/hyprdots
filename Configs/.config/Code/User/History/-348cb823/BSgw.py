...
# Create data loaders
train_dataset = XCAT3DDataset(data_file, dataset='training')
train_dataloader = torch.utils.data.DataLoader(train_dataset, batch_size=1, shuffle=True, num_workers=4,
                                               pin_memory=True)
val_dataset = XCAT3DDataset(data_file, dataset='validation')
...
if fresh_model:
    ...
    # Load model info
    model = torch.load('/scratch/tmp/a_wels03/checkpoints/optical_flow_3d.pt')
