...
sudo cp polybar/config.ini /etc/polybar/config.init
cp polybar/system-nvidia-smi.sh ~/polybar-scripts/system-nvidia-smi.sh
chmod +x ~/polybar-scripts/system-nvidia-smi.sh
