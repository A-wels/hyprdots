...
const StartScreen = ({ navigation }) => {
  ...
  const handleStartButton = () => {
    if (names.length == 0) {
      ...
      console.log("pointsToWinDisplay", pointsToWinDisplay)
      if (pointsToWinDisplay == '') {
        chosenPointsToWin = 10;
        setPointsToWin(10);
      }
      console.log(pointsToWin)
      navigation.navigate('RateKunst', { names: names, setID: selectedItems, pointsToWin: pointsToWin });
    }
  }
