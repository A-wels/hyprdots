...
use crate::structs::filesystem::{save_timestamp_linux, load_timestamp_linux, load_subscriptions, save_subscriptions};

use super::{Subscription, Token, subscription};
...
impl Server {
    ...
    pub fn new(url: String, protocol: String) -> Server {
        ...
        if subscriptions_loaded.is_ok(){
             ...
             subscriptions: Vec<Subscription> = vec![];
        }
